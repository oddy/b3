...
#
# Be strict about the data types matching, except when incoming data is null
# This lets us more easily interop with dynamic, which sends 'bytes' for nulls because it can't know what the actual type is.
