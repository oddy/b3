...
def test_enc_keytype_str_bytes():
    ...
    assert encode_key("Виагра") == (0x02, SBytes("0c d0 92 d0 b8 d0 b0 d0 b3 d1 80 d0 b0"))
...
def test_dec_keytype_str_bytes():
    ...
    assert decode_key(0x02, SBytes("0c d0 92 d0 b8 d0 b0 d0 b3 d1 80 d0 b0"), 0) == ("Виагра", 13)
...
def test_enc_header_keys():
    ...
    assert encode_item("Виагра", 0, b"") == (SBytes("02 0c d0 92 d0 b8 d0 b0 d0 b3 d1 80 d0 b0"), b"")
