...
def test_base_bool_enc():
    ...
    assert encode_bool(False)  == b""                       # zero-value mode

def test_base_bool_dec():
    assert decode_bool(SBytes("01"),0,1) is True
    assert decode_bool(SBytes("00"),0,1) is False           # nominal
    assert decode_bool(SBytes(""),0,0)   is False           # zero-value mode
...
def test_base_stamp64_dec():
    ...
    assert decode_stamp64(SBytes("0"),0,0)                        == timZero        # zero-value mode
